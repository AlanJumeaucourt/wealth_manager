...
/** --- Custom composite TypeBox (CUSTOM_TYPEBOX_SCHEMAS) --- */

/** Transaction row embedded in GET /potential_refunds (matches TransactionRow in potentialRefunds service; selectAll may add extra columns). */
