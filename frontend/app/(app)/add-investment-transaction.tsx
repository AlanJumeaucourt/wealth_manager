...
export default function AddInvestmentTransactionScreen() {
  ...
  const [selectedAccountName, setSelectedAccountName] = useState<string>(
    transaction
      ? accounts.find((acc: Account) => acc.id === transaction.from_account_id)?.name || ""
      : "",
  );
  ...
  const [_assetName, setAssetName] = useState(transaction ? transaction.asset_name : "");
      ...
      <View style={sharedStyles.header}>
        ...
        <View style={sharedStyles.headerTitleContainer}>
          <Text style={sharedStyles.headerTitle}>
            {transaction ? `Edit Investment Transaction` : "Add New Investment Transaction"}
          </Text>
        </View>
        <Image
        ...
        <Surface style={styles.card}>
          ...
          <View style={styles.activityTypeContainer}>
            {["buy", "sell", "deposit", "withdrawal"].map((type) => (
              ...
              >
                <Ionicons
                  name={
                    type === "buy" || type === "deposit" ? "arrow-down-circle" : "arrow-up-circle"
                  }
                  size={24}
          ...
          <View style={styles.section}>
            ...
            <SearchableModal
              ...
              label={
                activityType === "buy" || activityType === "deposit"
                  ? "From (Source) Account"
                  : "Investment Account"
              }
            ...
            <View style={styles.row}>
              ...
              <View style={styles.halfWidth}>
                <TextInput
                  ...
                  style={styles.input}
                  mode="outlined"
                  right={<TextInput.Affix text={preferredCurrency} />}
                />
              </View>
            </View>
          ...
          <View style={styles.totalSection}>
            ...
            <Text style={styles.totalValue}>
              {calculateTotal().toLocaleString()} {preferredCurrency}
            </Text>
          </View>
