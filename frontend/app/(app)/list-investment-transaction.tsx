...
export default function InvestmentTransactionListScreen() {
  ...
  const formatCurrency = (amount: number) => formatCurrencyValue(amount, preferredCurrency);
    ...
    return (
      ...
      >
        <View style={styles.transactionHeader}>
          ...
          >
            <Text style={styles.activityTypeText}>{item.activity_type.toUpperCase()}</Text>
          </View>
        </View>
    ...
    <View style={sharedStyles.container}>
      <View style={sharedStyles.header}>
        ...
        <Pressable
          ...
          onPress={() => router.push("/(app)/add-investment-transaction")}
        >
