...
export function AccountSummary({ accounts, banks }: Props) {
  ...
  const balancesByType = accounts.reduce(
    (acc, account) => {
  ...
  const accountTypeOrder: Account["type"][] = [
    "checking",
    "savings",
    "investment",
  ]
  ...
  return (
    <div className="bg-card rounded-xl border p-6 shadow-sm">
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        {(["all", "checking", "savings", "investment"] as const).map(
          tabValue => (
