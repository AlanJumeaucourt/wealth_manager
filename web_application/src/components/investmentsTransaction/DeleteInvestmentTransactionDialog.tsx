...
export function DeleteInvestmentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="..." aria-describedby="delete-investment-description">
        <DialogHeader>
          ...
          <div id="delete-investment-description" className="...">
            <DialogDescription>
              ...
              <div className="mt-2 text-sm">
                ...
                <p><strong>Quantity:</strong> {investment.quantity.toLocaleString()}</p>
                <p><strong>Unit Price:</strong> {new Intl.NumberFormat('en-US', {
                  style: 'currency',
                  currency: 'EUR'
                }).format(investment.unit_price)}</p>
                <p><strong>Total:</strong> {new Intl.NumberFormat('en-US', {
                  style: 'currency',
                  currency: 'EUR'
                }).format(investment.total_paid || 0)}</p>
