      ...
      <div className="rounded-lg border bg-background p-2 shadow-sm">
        <div className="flex flex-col">
          ...
          <span className="text-[0.65rem] text-muted-foreground">
            {((payload[0].value / (principalPaid + interestPaid + remainingBalance)) * 100).toFixed(
              1,
            )}
            %
          </span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span>
                  {formatCurrency(principalPaid)} of {formatCurrency(liability.principal_amount)}
                </span>
              </div>
            </div>
            ...
            {liability.missed_payments_count && liability.missed_payments_count > 0 && (
              <div className="rounded-lg bg-destructive/10 p-3 border border-destructive/20">
                ...
                <div className="text-xl font-bold text-destructive">
                  {liability.missed_payments_count}
                </div>
              </div>
            )}
          </div>
